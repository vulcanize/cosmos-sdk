...
var (
	...
	fd_SnapshotItem_app_version       protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_SnapshotItem_app_version = md_SnapshotItem.Fields().ByName("app_version")
}
...
func (x *fastReflection_SnapshotItem) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Item != nil {
		...
		case *SnapshotItem_AppVersion:
			v := o.AppVersion
			value := protoreflect.ValueOfMessage(v.ProtoReflect())
			if !f(fd_SnapshotItem_app_version, value) {
				return
			}
		}
	}
...
func (x *fastReflection_SnapshotItem) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "cosmos.base.snapshots.v1beta1.SnapshotItem.app_version":
		if x.Item == nil {
			return false
		} else if _, ok := x.Item.(*SnapshotItem_AppVersion); ok {
			return true
		} else {
			return false
		}
...
func (x *fastReflection_SnapshotItem) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.base.snapshots.v1beta1.SnapshotItem.app_version":
		if x.Item == nil {
			return protoreflect.ValueOfMessage((*SnapshotAppVersion)(nil).ProtoReflect())
		} else if v, ok := x.Item.(*SnapshotItem_AppVersion); ok {
			return protoreflect.ValueOfMessage(v.AppVersion.ProtoReflect())
		} else {
			return protoreflect.ValueOfMessage((*SnapshotAppVersion)(nil).ProtoReflect())
		}
	default:
...
func (x *fastReflection_SnapshotItem) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	...
	case "cosmos.base.snapshots.v1beta1.SnapshotItem.app_version":
		cv := value.Message().Interface().(*SnapshotAppVersion)
		x.Item = &SnapshotItem_AppVersion{AppVersion: cv}
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.snapshots.v1beta1.SnapshotItem"))
		}
...
func (x *fastReflection_SnapshotItem) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.base.snapshots.v1beta1.SnapshotItem.app_version":
		if x.Item == nil {
			value := &SnapshotAppVersion{}
			oneofValue := &SnapshotItem_AppVersion{AppVersion: value}
			x.Item = oneofValue
			return protoreflect.ValueOfMessage(value.ProtoReflect())
		}
		switch m := x.Item.(type) {
		case *SnapshotItem_AppVersion:
			return protoreflect.ValueOfMessage(m.AppVersion.ProtoReflect())
		default:
			value := &SnapshotAppVersion{}
			oneofValue := &SnapshotItem_AppVersion{AppVersion: value}
			x.Item = oneofValue
...
func (x *fastReflection_SnapshotItem) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	...
	case "cosmos.base.snapshots.v1beta1.SnapshotItem.item":
		...
		case *SnapshotItem_AppVersion:
			return x.Descriptor().Fields().ByName("app_version")
		}
	default:
...
func (x *fastReflection_SnapshotItem) ProtoMethods() *protoiface.Methods {
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		case *SnapshotItem_Schema:
			...
			dAtA[i] = 0x32
		case *SnapshotItem_AppVersion:
			encoded, err := options.Marshal(x.AppVersion)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 7:
				...
				x.Item = &SnapshotItem_AppVersion{v}
				iNdEx = postIndex
			default:
				iNdEx = preIndex
				skippy, err := runtime.Skip(dAtA[iNdEx:])
...
var (
	md_SnapshotAppVersion         protoreflect.MessageDescriptor
	fd_SnapshotAppVersion_version protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_base_snapshots_v1beta1_snapshot_proto_init()
	md_SnapshotAppVersion = File_cosmos_base_snapshots_v1beta1_snapshot_proto.Messages().ByName("SnapshotAppVersion")
	fd_SnapshotAppVersion_version = md_SnapshotAppVersion.Fields().ByName("version")
}

var _ protoreflect.Message = (*fastReflection_SnapshotAppVersion)(nil)

type fastReflection_SnapshotAppVersion SnapshotAppVersion

func (x *SnapshotAppVersion) ProtoReflect() protoreflect.Message {
	return (*fastReflection_SnapshotAppVersion)(x)
}

func (x *SnapshotAppVersion) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_base_snapshots_v1beta1_snapshot_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_SnapshotAppVersion_messageType fastReflection_SnapshotAppVersion_messageType
var _ protoreflect.MessageType = fastReflection_SnapshotAppVersion_messageType{}

type fastReflection_SnapshotAppVersion_messageType struct{}

func (x fastReflection_SnapshotAppVersion_messageType) Zero() protoreflect.Message {
	return (*fastReflection_SnapshotAppVersion)(nil)
}
func (x fastReflection_SnapshotAppVersion_messageType) New() protoreflect.Message {
	return new(fastReflection_SnapshotAppVersion)
}
func (x fastReflection_SnapshotAppVersion_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_SnapshotAppVersion
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_SnapshotAppVersion) Descriptor() protoreflect.MessageDescriptor {
	return md_SnapshotAppVersion
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_SnapshotAppVersion) Type() protoreflect.MessageType {
	return _fastReflection_SnapshotAppVersion_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_SnapshotAppVersion) New() protoreflect.Message {
	return new(fastReflection_SnapshotAppVersion)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_SnapshotAppVersion) Interface() protoreflect.ProtoMessage {
	return (*SnapshotAppVersion)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_SnapshotAppVersion) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Version != uint64(0) {
		value := protoreflect.ValueOfUint64(x.Version)
		if !f(fd_SnapshotAppVersion_version, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_SnapshotAppVersion) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.base.snapshots.v1beta1.SnapshotAppVersion.version":
		return x.Version != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.snapshots.v1beta1.SnapshotAppVersion"))
		}
		panic(fmt.Errorf("message cosmos.base.snapshots.v1beta1.SnapshotAppVersion does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SnapshotAppVersion) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.base.snapshots.v1beta1.SnapshotAppVersion.version":
		x.Version = uint64(0)
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_SnapshotAppVersion) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.base.snapshots.v1beta1.SnapshotAppVersion.version":
		value := x.Version
		return protoreflect.ValueOfUint64(value)
	default:
		...
		panic(fmt.Errorf("message cosmos.base.snapshots.v1beta1.SnapshotAppVersion does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SnapshotAppVersion) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.base.snapshots.v1beta1.SnapshotAppVersion.version":
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SnapshotAppVersion) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.base.snapshots.v1beta1.SnapshotAppVersion.version":
		panic(fmt.Errorf("field version of message cosmos.base.snapshots.v1beta1.SnapshotAppVersion is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.base.snapshots.v1beta1.SnapshotAppVersion"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_SnapshotAppVersion) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.base.snapshots.v1beta1.SnapshotAppVersion.version":
		return protoreflect.ValueOfUint64(uint64(0))
	default:
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_SnapshotAppVersion) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.base.snapshots.v1beta1.SnapshotAppVersion", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_SnapshotAppVersion) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_SnapshotAppVersion) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_SnapshotAppVersion) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_SnapshotAppVersion) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*SnapshotAppVersion)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SnapshotAppVersion: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: SnapshotAppVersion: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 0 {
...
func (x *SnapshotItem) GetAppVersion() *SnapshotAppVersion {
	if x, ok := x.GetItem().(*SnapshotItem_AppVersion); ok {
		return x.AppVersion
	}
	return nil
}
...
type SnapshotItem_AppVersion struct {
	AppVersion *SnapshotAppVersion `protobuf:"bytes,7,opt,name=app_version,json=appVersion,proto3,oneof"`
}
...
func (x *SnapshotAppVersion) Reset() {
	*x = SnapshotAppVersion{}
	if protoimpl.UnsafeEnabled {
		mi := &file_cosmos_base_snapshots_v1beta1_snapshot_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *SnapshotAppVersion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SnapshotAppVersion) ProtoMessage() {}

// Deprecated: Use SnapshotAppVersion.ProtoReflect.Descriptor instead.
func (*SnapshotAppVersion) Descriptor() ([]byte, []int) {
	return file_cosmos_base_snapshots_v1beta1_snapshot_proto_rawDescGZIP(), []int{9}
}

func (x *SnapshotAppVersion) GetVersion() uint64 {
	if x != nil {
		return x.Version
	}
	return 0
...
var file_cosmos_base_snapshots_v1beta1_snapshot_proto_rawDesc = []byte{
	...
	0x48, 0x61, 0x73, 0x68, 0x65, 0x73, 0x22, 0xd7, 0x04, 0x0a, 0x0c, 0x53, 0x6e, 0x61, 0x70, 0x73,
	...
	0x6d, 0x61, 0x12, 0x54, 0x0a, 0x0b, 0x61, 0x70, 0x70, 0x5f, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
	0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	...
	0x41, 0x70, 0x70, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x0a, 0x61, 0x70,
	0x70, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x06, 0x0a, 0x04, 0x69, 0x74, 0x65, 0x6d,
	...
	0x79, 0x73, 0x22, 0x2e, 0x0a, 0x12, 0x53, 0x6e, 0x61, 0x70, 0x73, 0x68, 0x6f, 0x74, 0x41, 0x70,
	...
	0x6f, 0x6e, 0x42, 0x8a, 0x02, 0x0a, 0x21, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f,
	...
	,
...
var file_cosmos_base_snapshots_v1beta1_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_cosmos_base_snapshots_v1beta1_snapshot_proto_goTypes = []interface{}{
	...
	(*SnapshotAppVersion)(nil),       // 9: cosmos.base.snapshots.v1beta1.SnapshotAppVersion
}
var file_cosmos_base_snapshots_v1beta1_snapshot_proto_depIdxs = []int32{
	...
	9, // 7: cosmos.base.snapshots.v1beta1.SnapshotItem.app_version:type_name -> cosmos.base.snapshots.v1beta1.SnapshotAppVersion
...
func file_cosmos_base_snapshots_v1beta1_snapshot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_base_snapshots_v1beta1_snapshot_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SnapshotAppVersion); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
