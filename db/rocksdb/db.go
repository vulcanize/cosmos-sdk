...
var (
	_ types.DBConnection = (*RocksDB)(nil)
	_ types.DBReader     = (*dbTxn)(nil)
	_ types.DBWriter     = (*dbWriter)(nil)
	_ types.DBReadWriter = (*dbWriter)(nil)
)
...
func (mgr *dbManager) Reader() types.DBReader {
	mgr.mtx.RLock()
...
func (mgr *dbManager) ReaderAt(version uint64) (types.DBReader, error) {
	mgr.mtx.RLock()
	defer mgr.mtx.RUnlock()
...
func (mgr *dbManager) ReadWriter() types.DBReadWriter {
	mgr.mtx.RLock()
	defer mgr.mtx.RUnlock()
...
func (mgr *dbManager) Writer() types.DBWriter {
	mgr.mtx.RLock()
	defer mgr.mtx.RUnlock()
	atomic.AddInt32(&mgr.openWriters, 1)
