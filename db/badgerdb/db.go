...
func (b *BadgerDB) ReadWriter() dbm.DBReadWriter {
	...
	return &badgerTxn{txn: b.db.NewTransactionAt(b.vmgr.lastCommitTs(), true), db: b, writer: true}
}
...
func (b *BadgerDB) Versions() dbm.VersionSet {
	b.mtx.RLock()
	defer b.mtx.RUnlock()
	return b.vmgr
}

func (b *BadgerDB) SaveVersion(target uint64) (uint64, error) {
...
func (tx *badgerTxn) Commit() error {
