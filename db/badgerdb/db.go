...
var (
	_ types.DBConnection = (*BadgerDB)(nil)
	_ types.DBReader     = (*badgerTxn)(nil)
	_ types.DBWriter     = (*badgerWriter)(nil)
	_ types.DBReadWriter = (*badgerWriter)(nil)
...
func (b *BadgerDB) Reader() types.DBReader {
	b.mtx.RLock()
	ts := b.vmgr.lastTs
	b.mtx.RUnlock()
...
func (b *BadgerDB) ReaderAt(version uint64) (types.DBReader, error) {
	b.mtx.RLock()
	defer b.mtx.RUnlock()
...
func (b *BadgerDB) ReadWriter() types.DBReadWriter {
...
func (b *BadgerDB) Writer() types.DBWriter {
